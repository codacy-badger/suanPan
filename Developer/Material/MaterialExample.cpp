...
SUANPAN_EXPORT void new_materialexample(unique_ptr<Material>& return_obj, istringstream& command) {
	...
	} else suanpan_debug("new_materialexample() assumes zero hardening ratio.\n");
	...
	} else suanpan_debug("new_materialexample() assumes isotropic hardening.\n");
	...
	} else suanpan_debug("new_materialexample() assumes zero density.\n");
