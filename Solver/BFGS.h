 ...
 * convergence rate. The (L-)BFGS class supports both conventional BGFS and
 * L-BFGS method which uses limited history infomration.
 *
 * \f{gather}{
...
public:
	explicit BFGS(unsigned = 0, unsigned = 100);
