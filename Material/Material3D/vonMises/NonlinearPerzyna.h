 ...
 ******************************************************************************/
/**
 * @class NonlinearPerzyna
 * @brief The NonlinearPerzyna class.
 * 
 ...
 * @date 24/04/2019
 * @version 1.0.0
 * @file NonlinearPerzyna.h
 * @addtogroup Material-3D
 * @{
 */

#ifndef NONLINEARPERZYNA_H
#define NONLINEARPERZYNA_H

#include <Material/Material3D/Material3D.h>

struct DataNonlinearPerzyna {
	...
	const double triple_shear;  // double shear modulus

	const double factor_a;
};

class NonlinearPerzyna : DataNonlinearPerzyna, public Material3D {
