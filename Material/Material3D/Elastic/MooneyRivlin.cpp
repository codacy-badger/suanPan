...
const double MooneyRivlin::one_three = 1. / 3.;
const double MooneyRivlin::two_three = 2. * one_three;
const double MooneyRivlin::four_three = 2. * two_three;
const double MooneyRivlin::five_three = 5. * one_three;
const double MooneyRivlin::eight_nine = two_three * four_three;
...
int MooneyRivlin::update_trial_status(const vec& t_strain) {
	vec G = weight % (trial_strain = t_strain) + tensor::unit_tensor2;
