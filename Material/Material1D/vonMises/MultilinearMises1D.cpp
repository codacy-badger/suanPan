...
MultilinearMises1D::MultilinearMises1D(const unsigned T, const double E, mat&& H, const double R)
	...
	for(unsigned I = 0; I < H.n_rows - 1; ++I) H(I, 2) = (H(I + 1, 1) - H(I, 1)) / (H(I + 1, 0) - H(I, 0));
...
void MultilinearMises1D::print() {
	suanpan_info("1D multilinear hardening material using J2 plasticity and associated flow rule.\n");
	suanpan_info("current strain: %.3E\tsurrent stress: %.3E\n", current_strain(0), current_stress(0));
}
