...
int Combine::initialize(const shared_ptr<DomainBase>& D) {
	for(auto I : tag_pool) if(D->find_amplitude(unsigned(I))) amp_pool.emplace_back(D->get_amplitude(unsigned(I)));
