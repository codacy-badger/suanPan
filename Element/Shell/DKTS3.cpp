...
const unsigned DKTS3::s_node = 3;
const unsigned DKTS3::s_dof = 6;
const unsigned DKTS3::s_size = s_dof * s_node;
...
void DKTS3::initialize(const shared_ptr<DomainBase>& D) {
...
int DKTS3::update_status() {
	...
	mat m_stiffness(9, 9, fill::zeros), p_stiffness(9, 9, fill::zeros);
	vec m_resistance(9, fill::zeros), p_resistance(9, fill::zeros);
...
void DKTS3::GetDisplacement(vtkSmartPointer<vtkDoubleArray>& arrays) {
