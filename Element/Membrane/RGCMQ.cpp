...
const unsigned RGCMQ::m_node = 4;
const unsigned RGCMQ::m_dof = 3;
const unsigned RGCMQ::m_size = m_dof * m_node;
...
RGCMQ::IntegrationPoint::IntegrationPoint(vec&& C, const double F, unique_ptr<Material>&& M)
...
RGCMQ::RGCMQ(const unsigned T, uvec&& N, const unsigned M, const double TH, const char IP, const double RHOX, const unsigned MATX, const double RHOY, const unsigned MATY)
