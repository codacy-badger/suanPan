...
const unsigned CINP4::m_node = 4;
const unsigned CINP4::m_dof = 2;
const unsigned CINP4::m_size = m_dof * m_node;
...
void CINP4::initialize(const shared_ptr<DomainBase>& D) {
...
void CINP4::print() {
	suanpan_info("CINP4 element (doi: 10.1016/0045-7949(84)90019-1) connects: ");
...
void CINP4::GetDisplacement(vtkSmartPointer<vtkDoubleArray>& arrays) {
