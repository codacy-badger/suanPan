...
const unsigned CAX4::m_node = 4;
const unsigned CAX4::m_dof = 2;
const unsigned CAX4::m_size = m_dof * m_node;
...
void CAX4::GetDisplacement(vtkSmartPointer<vtkDoubleArray>& arrays) {
