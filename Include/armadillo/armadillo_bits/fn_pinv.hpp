...
inline
typename enable_if2<is_real<typename T1::pod_type>::value, const Op<T1, op_pinv>>::result pinv
(
...
typename enable_if2<is_real<typename T1::pod_type>::value, bool>::result pinv
(
