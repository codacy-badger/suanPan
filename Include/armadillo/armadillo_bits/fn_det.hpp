...
inline
typename enable_if2<is_supported_blas_type<typename T1::elem_type>::value, typename T1::elem_type>::result det
(
...
arma_inline
const typename arma_scalar_only<T>::result& det(const T& x) { return x; }
