...
template<typename eT, typename T1> inline subview_cube_slices<eT, T1>::~subview_cube_slices() {
	arma_extra_debug_sigprint();
}

template<typename eT, typename T1> arma_inline subview_cube_slices<eT, T1>::subview_cube_slices
(
	const Cube<eT>& in_m,
...
void subview_cube_slices<eT, T1>::inplace_op(const eT val) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> template<typename op_type, typename expr> inline
void subview_cube_slices<eT, T1>::inplace_op(const BaseCube<eT, expr>& x) {
	arma_extra_debug_sigprint();
...
void subview_cube_slices<eT, T1>::fill(const eT val) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::zeros() {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::ones() {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::operator+=(const eT val) {
	arma_extra_debug_sigprint();
...
void subview_cube_slices<eT, T1>::operator_equ(const subview_cube_slices<eT, T2>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> template<typename T2> inline
void subview_cube_slices<eT, T1>::operator=(const subview_cube_slices<eT, T2>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::operator=(const subview_cube_slices<eT, T1>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> template<typename expr> inline
void subview_cube_slices<eT, T1>::operator=(const BaseCube<eT, expr>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::extract(Cube<eT>& out, const subview_cube_slices<eT, T1>& in) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::plus_inplace(Cube<eT>& out, const subview_cube_slices& in) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::minus_inplace(Cube<eT>& out, const subview_cube_slices& in) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::schur_inplace(Cube<eT>& out, const subview_cube_slices& in) {
	arma_extra_debug_sigprint();
...
template<typename eT, typename T1> inline
void subview_cube_slices<eT, T1>::div_inplace(Cube<eT>& out, const subview_cube_slices& in) {
	arma_extra_debug_sigprint();
