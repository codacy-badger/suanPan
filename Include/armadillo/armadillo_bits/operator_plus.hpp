...
typename enable_if2<is_arma_type<T1>::value, const T1&>::result operator+
(const T1& X) {
...
//! Base + scalar
template<typename T1> arma_inline
typename enable_if2<is_arma_type<T1>::value, const eOp<T1, eop_scalar_plus>>::result operator+
