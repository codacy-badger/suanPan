...
>::result mvnrnd(const Base<typename T1::elem_type, T1>& M, const Base<typename T1::elem_type, T2>& C) {
...
<
	is_real<typename T1::elem_type>::value,
	const Glue<T1, T2, glue_mvnrnd>
>::result mvnrnd(const Base<typename T1::elem_type, T1>& M, const Base<typename T1::elem_type, T2>& C, const uword N) {
	arma_extra_debug_sigprint();
...
<
	is_real<typename T1::elem_type>::value,
	bool
>::result mvnrnd(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& M, const Base<typename T1::elem_type, T2>& C) {
	arma_extra_debug_sigprint();
...
<
	is_real<typename T1::elem_type>::value,
	bool
>::result mvnrnd(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& M, const Base<typename T1::elem_type, T2>& C, const uword N) {
	arma_extra_debug_sigprint();
