...
template<typename eT> template<uword fixed_n_elem> const uword Row<eT>::fixed<fixed_n_elem>::n_rows = 1u;

template<typename eT> template<uword fixed_n_elem> const uword Row<eT>::fixed<fixed_n_elem>::n_cols = fixed_n_elem;

template<typename eT> template<uword fixed_n_elem> const uword Row<eT>::fixed<fixed_n_elem>::n_elem = fixed_n_elem;
