...
public:
	...
	template<typename eT, typename TA, typename TB> arma_cold
	inline
	static
	void apply
	(
...
public:
	...
	template<typename eT, typename TA, typename TB> arma_hot
	inline
	static
	void apply
	(
...
public:
	...
	template<typename eT, typename TA, typename TB> inline
	static
	void apply_blas_type(Mat<eT>& C, const TA& A, const TB& B, const eT alpha = eT(1), const eT beta = eT(0)) {
		arma_extra_debug_sigprint();
	...
	template<typename eT, typename TA, typename TB> inline
	static
	void apply(Mat<eT>& C, const TA& A, const TB& B, const eT alpha = eT(1), const eT beta = eT(0)) { gemm_emul<do_trans_A, do_trans_B, use_alpha, use_beta>::apply(C, A, B, alpha, beta); }

	template<typename TA, typename TB> arma_inline
	static
	void apply
	(
		Mat<float>& C,
