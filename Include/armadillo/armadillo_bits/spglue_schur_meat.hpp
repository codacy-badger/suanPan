...
inline
void spglue_schur::apply(SpMat<typename T1::elem_type>& out, const SpGlue<T1, T2, spglue_schur>& X) {
...
inline
void spglue_schur::apply_noalias(SpMat<eT>& out, const SpProxy<T1>& pa, const SpProxy<T2>& pb) {
	arma_extra_debug_sigprint();
...
inline
void spglue_schur::apply_noalias(SpMat<eT>& out, const SpMat<eT>& A, const SpMat<eT>& B) {
	arma_extra_debug_sigprint();
...
void spglue_schur_misc::dense_schur_sparse(SpMat<typename T1::elem_type>& out, const T1& x, const T2& y) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_schur_mixed::sparse_schur_sparse(SpMat<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result>& out, const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spglue_schur_mixed::dense_schur_sparse(SpMat<typename promote_type<typename T1::elem_type, typename T2::elem_type>::result>& out, const T1& X, const T2& Y) {
	arma_extra_debug_sigprint();
