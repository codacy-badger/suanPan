...
bool internal_approx_equal_abs_diff(const eT& x, const eT& y, const typename get_pod_type<eT>::result tol) {
	...
	if(x != y) {
		...
		} else { if(eop_aux::arma_abs((cond_rel<is_not_complex<eT>::value>::gt(x, y)) ? (x - y) : (y - x)) > tol) { return false; } }
	}
...
template<typename eT> arma_inline
bool internal_approx_equal_rel_diff(const eT& a, const eT& b, const typename get_pod_type<eT>::result tol) {
	typedef typename get_pod_type<eT>::result T;
...
template<bool use_abs_diff, bool use_rel_diff, typename T1, typename T2> inline
bool internal_approx_equal_worker
(
...
bool internal_approx_equal_handler(const T1& A, const T2& B, const char* method, const typename T1::pod_type abs_tol, const typename T1::pod_type rel_tol) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
bool internal_approx_equal_handler(const T1& A, const T2& B, const char* method, const typename T1::pod_type tol) {
	arma_extra_debug_sigprint();
...
inline
bool approx_equal(const Base<typename T1::elem_type, T1>& A, const Base<typename T1::elem_type, T2>& B, const char* method, const typename T1::pod_type tol) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> arma_warn_unused
inline
bool approx_equal(const BaseCube<typename T1::elem_type, T1>& A, const BaseCube<typename T1::elem_type, T2>& B, const char* method, const typename T1::pod_type tol) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> arma_warn_unused
inline
bool approx_equal(const Base<typename T1::elem_type, T1>& A, const Base<typename T1::elem_type, T2>& B, const char* method, const typename T1::pod_type abs_tol, const typename T1::pod_type rel_tol) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> arma_warn_unused
inline
bool approx_equal(const BaseCube<typename T1::elem_type, T1>& A, const BaseCube<typename T1::elem_type, T2>& B, const char* method, const typename T1::pod_type abs_tol, const typename T1::pod_type rel_tol) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> arma_warn_unused
inline
bool approx_equal(const SpBase<typename T1::elem_type, T1>& A, const SpBase<typename T1::elem_type, T2>& B, const char* method, const typename T1::pod_type tol) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> arma_warn_unused
inline
bool approx_equal(const SpBase<typename T1::elem_type, T1>& A, const SpBase<typename T1::elem_type, T2>& B, const char* method, const typename T1::pod_type abs_tol, const typename T1::pod_type rel_tol) {
	arma_extra_debug_sigprint();
