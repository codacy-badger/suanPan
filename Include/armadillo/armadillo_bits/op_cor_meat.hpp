...
void op_cor::direct_cor(Mat<eT>& out, const Mat<eT>& A, const uword norm_type) {
...
void op_cor::direct_cor(Mat<std::complex<T>>& out, const Mat<std::complex<T>>& A, const uword norm_type) {
	arma_extra_debug_sigprint();
...
void op_cor::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_cor>& in) {
	arma_extra_debug_sigprint();
