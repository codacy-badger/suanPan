...
void spop_diagmat::apply(SpMat<typename T1::elem_type>& out, const SpOp<T1, spop_diagmat>& in) {
...
template<typename T1> inline
void spop_diagmat::apply_noalias(SpMat<typename T1::elem_type>& out, const SpBase<typename T1::elem_type, T1>& expr) {
	arma_extra_debug_sigprint();
...
void spop_diagmat::apply_noalias(SpMat<typename T1::elem_type>& out, const SpGlue<T1, T2, spglue_plus>& expr) {
	arma_extra_debug_sigprint();
	...
	} else // generate a diagonal matrix out of a matrix
	{
		...
		SpMat<eT> BB;
		spop_diagmat::apply_noalias(BB, B);
...
template<typename T1, typename T2> inline
void spop_diagmat::apply_noalias(SpMat<typename T1::elem_type>& out, const SpGlue<T1, T2, spglue_minus>& expr) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spop_diagmat::apply_noalias(SpMat<typename T1::elem_type>& out, const SpGlue<T1, T2, spglue_schur>& expr) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2> inline
void spop_diagmat::apply_noalias(SpMat<typename T1::elem_type>& out, const SpGlue<T1, T2, spglue_times>& expr) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void spop_diagmat2::apply(SpMat<typename T1::elem_type>& out, const SpOp<T1, spop_diagmat2>& in) {
	arma_extra_debug_sigprint();
...
void spop_diagmat2::apply_noalias(SpMat<eT>& out, const SpMat<eT>& X, const uword row_offset, const uword col_offset) {
	arma_extra_debug_sigprint();
