...
void op_cumsum::apply_noalias(Mat<eT>& out, const Mat<eT>& X, const uword dim) {
...
void op_cumsum::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_cumsum>& in) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_cumsum_default::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_cumsum_default>& in) {
	arma_extra_debug_sigprint();
