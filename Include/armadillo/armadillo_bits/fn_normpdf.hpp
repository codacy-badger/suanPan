...
typename enable_if2<(is_real<typename T1::elem_type>::value), void>::result normpdf_helper(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& X_expr, const Base<typename T1::elem_type, T2>& M_expr, const Base<typename T1::elem_type, T3>& S_expr) {
...
typename enable_if2<(is_real<eT>::value), eT>::result normpdf(const eT x) {
...
typename enable_if2<(is_real<eT>::value), eT>::result normpdf(const eT x, const eT mu, const eT sigma) {
...
template<typename eT, typename T2, typename T3> inline
typename enable_if2<(is_real<eT>::value), Mat<eT>>::result normpdf(const eT x, const Base<eT, T2>& M_expr, const Base<eT, T3>& S_expr) {
	arma_extra_debug_sigprint();
...
typename enable_if2<(is_real<typename T1::elem_type>::value), Mat<typename T1::elem_type>>::result normpdf(const Base<typename T1::elem_type, T1>& X_expr) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
typename enable_if2<(is_real<typename T1::elem_type>::value), Mat<typename T1::elem_type>>::result normpdf(const Base<typename T1::elem_type, T1>& X_expr, const typename T1::elem_type mu, const typename T1::elem_type sigma) {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2, typename T3> inline
typename enable_if2<(is_real<typename T1::elem_type>::value), Mat<typename T1::elem_type>>::result normpdf(const Base<typename T1::elem_type, T1>& X_expr, const Base<typename T1::elem_type, T2>& M_expr, const Base<typename T1::elem_type, T3>& S_expr) {
	arma_extra_debug_sigprint();
