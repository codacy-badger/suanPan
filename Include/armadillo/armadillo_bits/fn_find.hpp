...
template<typename T1> arma_warn_unused
inline
const mtOp<uword, T1, op_find> find(const Base<typename T1::elem_type, T1>& X, const uword k, const char* direction = "first") {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
inline
uvec find(const BaseCube<typename T1::elem_type, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
inline
uvec find(const BaseCube<typename T1::elem_type, T1>& X, const uword k, const char* direction = "first") {
	arma_extra_debug_sigprint();
...
template<typename T1, typename op_rel_type> arma_warn_unused
inline
uvec find(const mtOpCube<uword, T1, op_rel_type>& X, const uword k = 0, const char* direction = "first") {
	arma_extra_debug_sigprint();
...
template<typename T1, typename T2, typename glue_rel_type> arma_warn_unused
inline
uvec find(const mtGlueCube<uword, T1, T2, glue_rel_type>& X, const uword k = 0, const char* direction = "first") {
	arma_extra_debug_sigprint();
...
>::result find_nonfinite(const T1& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
inline
uvec find_finite(const BaseCube<typename T1::elem_type, T1>& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_warn_unused
inline
uvec find_nonfinite(const BaseCube<typename T1::elem_type, T1>& X) {
	arma_extra_debug_sigprint();
