...
namespace solve_opts {
	...
	inline opts::opts(const uword in_flags)
		: flags(in_flags) {}
	...
	struct opts_fast : public opts {
		inline opts_fast()
			: opts(flag_fast) {}
	};

	struct opts_equilibrate : public opts {
		inline opts_equilibrate()
			: opts(flag_equilibrate) {}
	};

	struct opts_no_approx : public opts {
		inline opts_no_approx()
			: opts(flag_no_approx) {}
	};

	struct opts_triu : public opts {
		inline opts_triu()
			: opts(flag_triu) {}
	};

	struct opts_tril : public opts {
		inline opts_tril()
			: opts(flag_tril) {}
	};

	struct opts_no_band : public opts {
		inline opts_no_band()
			: opts(flag_no_band) {}
	};

	struct opts_no_sympd : public opts {
		inline opts_no_sympd()
			: opts(flag_no_sympd) {}
	};

	struct opts_allow_ugly : public opts {
		inline opts_allow_ugly()
			: opts(flag_allow_ugly) {}
	};
