...
template<typename eop_type> template<typename outT, typename T1> arma_hot
inline
void eop_core<eop_type>::apply(outT& out, const eOp<T1, eop_type>& x) {
	...
	if(Proxy<T1>::use_at == false) {
		...
		if(use_mp && mp_gate<eT>::eval(x.get_n_elem())) { arma_applier_2_mp(=); } else { arma_applier_2(=); }
	}
}

template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_plus(Mat<typename T1::elem_type>& out, const eOp<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_minus(Mat<typename T1::elem_type>& out, const eOp<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_schur(Mat<typename T1::elem_type>& out, const eOp<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_div(Mat<typename T1::elem_type>& out, const eOp<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply(Cube<typename T1::elem_type>& out, const eOpCube<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
	...
	if(ProxyCube<T1>::use_at == false) {
		...
		if(use_mp && mp_gate<eT>::eval(x.get_n_elem())) { arma_applier_3_mp(=); } else { arma_applier_3(=); }
	}
}

template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_plus(Cube<typename T1::elem_type>& out, const eOpCube<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_minus(Cube<typename T1::elem_type>& out, const eOpCube<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_schur(Cube<typename T1::elem_type>& out, const eOpCube<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename T1> arma_hot
inline
void eop_core<eop_type>::apply_inplace_div(Cube<typename T1::elem_type>& out, const eOpCube<T1, eop_type>& x) {
	arma_extra_debug_sigprint();
...
template<typename eop_type> template<typename eT> arma_hot
arma_inline
eT eop_core<eop_type>::process(const eT, const eT) {
...
template<> template<typename eT> arma_hot arma_inline eT eop_core<eop_sinc>::process(const eT val, const eT) { return arma_sinc(val); }
...
template<> template<typename eT> arma_hot arma_inline eT eop_core<eop_sign>::process(const eT val, const eT) { return arma_sign(val); }
