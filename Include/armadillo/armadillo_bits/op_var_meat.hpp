...
void op_var::apply(Mat<typename T1::pod_type>& out, const mtOp<typename T1::pod_type, T1, op_var>& in) {
...
template<typename T1> inline
typename T1::pod_type op_var::var_vec(const Base<typename T1::elem_type, T1>& X, const uword norm_type) {
	arma_extra_debug_sigprint();
...
typename get_pod_type<eT>::result op_var::var_vec(const subview_col<eT>& X, const uword norm_type) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
typename get_pod_type<eT>::result op_var::var_vec(const subview_row<eT>& X, const uword norm_type) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
eT op_var::direct_var(const eT* const X, const uword n_elem, const uword norm_type) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
eT op_var::direct_var_robust(const eT* const X, const uword n_elem, const uword norm_type) {
	arma_extra_debug_sigprint();
...
T op_var::direct_var(const std::complex<T>* const X, const uword n_elem, const uword norm_type) {
	arma_extra_debug_sigprint();
...
template<typename T> inline
T op_var::direct_var_robust(const std::complex<T>* const X, const uword n_elem, const uword norm_type) {
	arma_extra_debug_sigprint();
