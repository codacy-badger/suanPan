...
public:
	...
	template<typename T1> inline static bool direct_princomp
	(
	...
	template<typename T1> inline static void apply(Mat<typename T1::elem_type>& out, const Op<T1, op_princomp>& in);
};
