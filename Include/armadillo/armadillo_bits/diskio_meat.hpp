...
arma_cold
std::string diskio::gen_txt_header(const Mat<eT>&) {
	arma_type_check(( is_supported_elem_type<eT>::value == false ));

	if(is_u8<eT>::value) { return std::string("ARMA_MAT_TXT_IU001"); } else if(is_s8<eT>::value) { return std::string("ARMA_MAT_TXT_IS001"); } else if(is_u16<eT>::value) { return std::string("ARMA_MAT_TXT_IU002"); } else if(is_s16<eT>::value) { return std::string("ARMA_MAT_TXT_IS002"); } else if(is_u32<eT>::value) { return std::string("ARMA_MAT_TXT_IU004"); } else if(is_s32<eT>::value) { return std::string("ARMA_MAT_TXT_IS004"); }
#if defined(ARMA_USE_U64S64)
	else if(is_u64<eT>::value) { return std::string("ARMA_MAT_TXT_IU008"); } else if(is_s64<eT>::value) { return std::string("ARMA_MAT_TXT_IS008"); }
#endif
#if defined(ARMA_ALLOW_LONG)
	else if(is_ulng_t_32<eT>::value) { return std::string("ARMA_MAT_TXT_IU004"); } else if(is_slng_t_32<eT>::value) { return std::string("ARMA_MAT_TXT_IS004"); } else if(is_ulng_t_64<eT>::value) { return std::string("ARMA_MAT_TXT_IU008"); } else if(is_slng_t_64<eT>::value) { return std::string("ARMA_MAT_TXT_IS008"); }
#endif
	else if(is_float<eT>::value) { return std::string("ARMA_MAT_TXT_FN004"); } else if(is_double<eT>::value) { return std::string("ARMA_MAT_TXT_FN008"); } else if(is_complex_float<eT>::value) { return std::string("ARMA_MAT_TXT_FC008"); } else if(is_complex_double<eT>::value) { return std::string("ARMA_MAT_TXT_FC016"); }
...
template<typename eT> inline
arma_cold
std::string diskio::gen_bin_header(const Mat<eT>&) {
	arma_type_check(( is_supported_elem_type<eT>::value == false ));

	if(is_u8<eT>::value) { return std::string("ARMA_MAT_BIN_IU001"); } else if(is_s8<eT>::value) { return std::string("ARMA_MAT_BIN_IS001"); } else if(is_u16<eT>::value) { return std::string("ARMA_MAT_BIN_IU002"); } else if(is_s16<eT>::value) { return std::string("ARMA_MAT_BIN_IS002"); } else if(is_u32<eT>::value) { return std::string("ARMA_MAT_BIN_IU004"); } else if(is_s32<eT>::value) { return std::string("ARMA_MAT_BIN_IS004"); }
#if defined(ARMA_USE_U64S64)
	else if(is_u64<eT>::value) { return std::string("ARMA_MAT_BIN_IU008"); } else if(is_s64<eT>::value) { return std::string("ARMA_MAT_BIN_IS008"); }
#endif
#if defined(ARMA_ALLOW_LONG)
	else if(is_ulng_t_32<eT>::value) { return std::string("ARMA_MAT_BIN_IU004"); } else if(is_slng_t_32<eT>::value) { return std::string("ARMA_MAT_BIN_IS004"); } else if(is_ulng_t_64<eT>::value) { return std::string("ARMA_MAT_BIN_IU008"); } else if(is_slng_t_64<eT>::value) { return std::string("ARMA_MAT_BIN_IS008"); }
#endif
	else if(is_float<eT>::value) { return std::string("ARMA_MAT_BIN_FN004"); } else if(is_double<eT>::value) { return std::string("ARMA_MAT_BIN_FN008"); } else if(is_complex_float<eT>::value) { return std::string("ARMA_MAT_BIN_FC008"); } else if(is_complex_double<eT>::value) { return std::string("ARMA_MAT_BIN_FC016"); }
...
template<typename eT> inline
arma_cold
std::string diskio::gen_bin_header(const SpMat<eT>&) {
	arma_type_check(( is_supported_elem_type<eT>::value == false ));

	if(is_u8<eT>::value) { return std::string("ARMA_SPM_BIN_IU001"); } else if(is_s8<eT>::value) { return std::string("ARMA_SPM_BIN_IS001"); } else if(is_u16<eT>::value) { return std::string("ARMA_SPM_BIN_IU002"); } else if(is_s16<eT>::value) { return std::string("ARMA_SPM_BIN_IS002"); } else if(is_u32<eT>::value) { return std::string("ARMA_SPM_BIN_IU004"); } else if(is_s32<eT>::value) { return std::string("ARMA_SPM_BIN_IS004"); }
#if defined(ARMA_USE_U64S64)
	else if(is_u64<eT>::value) { return std::string("ARMA_SPM_BIN_IU008"); } else if(is_s64<eT>::value) { return std::string("ARMA_SPM_BIN_IS008"); }
#endif
#if defined(ARMA_ALLOW_LONG)
	else if(is_ulng_t_32<eT>::value) { return std::string("ARMA_SPM_BIN_IU004"); } else if(is_slng_t_32<eT>::value) { return std::string("ARMA_SPM_BIN_IS004"); } else if(is_ulng_t_64<eT>::value) { return std::string("ARMA_SPM_BIN_IU008"); } else if(is_slng_t_64<eT>::value) { return std::string("ARMA_SPM_BIN_IS008"); }
#endif
	else if(is_float<eT>::value) { return std::string("ARMA_SPM_BIN_FN004"); } else if(is_double<eT>::value) { return std::string("ARMA_SPM_BIN_FN008"); } else if(is_complex_float<eT>::value) { return std::string("ARMA_SPM_BIN_FC008"); } else if(is_complex_double<eT>::value) { return std::string("ARMA_SPM_BIN_FC016"); }
...
template<typename eT> inline
arma_cold
std::string diskio::gen_txt_header(const Cube<eT>&) {
	arma_type_check(( is_supported_elem_type<eT>::value == false ));

	if(is_u8<eT>::value) { return std::string("ARMA_CUB_TXT_IU001"); } else if(is_s8<eT>::value) { return std::string("ARMA_CUB_TXT_IS001"); } else if(is_u16<eT>::value) { return std::string("ARMA_CUB_TXT_IU002"); } else if(is_s16<eT>::value) { return std::string("ARMA_CUB_TXT_IS002"); } else if(is_u32<eT>::value) { return std::string("ARMA_CUB_TXT_IU004"); } else if(is_s32<eT>::value) { return std::string("ARMA_CUB_TXT_IS004"); }
#if defined(ARMA_USE_U64S64)
	else if(is_u64<eT>::value) { return std::string("ARMA_CUB_TXT_IU008"); } else if(is_s64<eT>::value) { return std::string("ARMA_CUB_TXT_IS008"); }
#endif
#if defined(ARMA_ALLOW_LONG)
	else if(is_ulng_t_32<eT>::value) { return std::string("ARMA_CUB_TXT_IU004"); } else if(is_slng_t_32<eT>::value) { return std::string("ARMA_CUB_TXT_IS004"); } else if(is_ulng_t_64<eT>::value) { return std::string("ARMA_CUB_TXT_IU008"); } else if(is_slng_t_64<eT>::value) { return std::string("ARMA_CUB_TXT_IS008"); }
#endif
	else if(is_float<eT>::value) { return std::string("ARMA_CUB_TXT_FN004"); } else if(is_double<eT>::value) { return std::string("ARMA_CUB_TXT_FN008"); } else if(is_complex_float<eT>::value) { return std::string("ARMA_CUB_TXT_FC008"); } else if(is_complex_double<eT>::value) { return std::string("ARMA_CUB_TXT_FC016"); }
...
template<typename eT> inline
arma_cold
std::string diskio::gen_bin_header(const Cube<eT>&) {
	arma_type_check(( is_supported_elem_type<eT>::value == false ));

	if(is_u8<eT>::value) { return std::string("ARMA_CUB_BIN_IU001"); } else if(is_s8<eT>::value) { return std::string("ARMA_CUB_BIN_IS001"); } else if(is_u16<eT>::value) { return std::string("ARMA_CUB_BIN_IU002"); } else if(is_s16<eT>::value) { return std::string("ARMA_CUB_BIN_IS002"); } else if(is_u32<eT>::value) { return std::string("ARMA_CUB_BIN_IU004"); } else if(is_s32<eT>::value) { return std::string("ARMA_CUB_BIN_IS004"); }
#if defined(ARMA_USE_U64S64)
	else if(is_u64<eT>::value) { return std::string("ARMA_CUB_BIN_IU008"); } else if(is_s64<eT>::value) { return std::string("ARMA_CUB_BIN_IS008"); }
#endif
#if defined(ARMA_ALLOW_LONG)
	else if(is_ulng_t_32<eT>::value) { return std::string("ARMA_CUB_BIN_IU004"); } else if(is_slng_t_32<eT>::value) { return std::string("ARMA_CUB_BIN_IS004"); } else if(is_ulng_t_64<eT>::value) { return std::string("ARMA_CUB_BIN_IU008"); } else if(is_slng_t_64<eT>::value) { return std::string("ARMA_CUB_BIN_IS008"); }
#endif
	else if(is_float<eT>::value) { return std::string("ARMA_CUB_BIN_FN004"); } else if(is_double<eT>::value) { return std::string("ARMA_CUB_BIN_FN008"); } else if(is_complex_float<eT>::value) { return std::string("ARMA_CUB_BIN_FC008"); } else if(is_complex_double<eT>::value) { return std::string("ARMA_CUB_BIN_FC016"); }
...
inline
arma_cold
file_type diskio::guess_file_type(std::istream& f) {
...
inline
arma_cold
std::string diskio::gen_tmp_name(const std::string& x) {
	union {
		uword val;
		void* ptr;
	} u;
...
inline
arma_cold
bool diskio::safe_rename(const std::string& old_name, const std::string& new_name) {
...
template<typename eT> inline
bool diskio::convert_token(eT& val, const std::string& token) {
	...
	if(is_real<eT>::value) { val = eT(std::strtod(str, &endptr)); } else {
...
bool diskio::convert_token(std::complex<T>& val, const std::string& token) {
	const size_t N = size_t(token.length());
...
inline
bool diskio::convert_naninf(eT& val, const std::string& token) {
...
template<typename eT> inline
bool diskio::save_raw_ascii(const Mat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! Matrices can be loaded in Matlab and Octave, as long as they don't have complex elements.
template<typename eT> inline
bool diskio::save_raw_ascii(const Mat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_raw_binary(const Mat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_raw_binary(const Mat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_arma_ascii(const Mat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! with a header that indicates the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::save_arma_ascii(const Mat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_csv_ascii(const Mat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! Save a matrix in CSV text format (human readable)
template<typename eT> inline
bool diskio::save_csv_ascii(const Mat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename T> inline
bool diskio::save_csv_ascii(const Mat<std::complex<T>>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_arma_binary(const Mat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! with a header that stores the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::save_arma_binary(const Mat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_pgm_binary(const Mat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! Save a matrix as a PGM greyscale image
template<typename eT> inline
bool diskio::save_pgm_binary(const Mat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
//! Save a matrix as a PGM greyscale image
template<typename T> inline
bool diskio::save_pgm_binary(const Mat<std::complex<T>>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! Save a matrix as a PGM greyscale image
template<typename T> inline
bool diskio::save_pgm_binary(const Mat<std::complex<T>>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_hdf5_binary(const Mat<eT>& x, const hdf5_name& spec, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
#if defined(ARMA_USE_HDF5)
	{
		...
		while((loc = full_name.find("/")) != std::string::npos) {
			...
			if(loc != 0) // Ignore the first /, if there is a leading /.
			{
				...
				if((gid < 0) && use_existing_file) { gid = arma_H5Gopen((groups.size() == 0) ? file : groups[groups.size() - 1], full_name.substr(0, loc).c_str(), H5P_DEFAULT); }
...
template<typename eT> inline
bool diskio::load_raw_ascii(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! NOTE: this is much slower than reading a file with a header.
template<typename eT> inline
bool diskio::load_raw_ascii(Mat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_raw_binary(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_raw_binary(Mat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	arma_ignore(err_msg);
...
//! with a header that indicates the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_ascii(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! with a header that indicates the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_ascii(Mat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_csv_ascii(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! Load a matrix in CSV text format (human readable)
template<typename eT> inline
bool diskio::load_csv_ascii(Mat<eT>& x, std::istream& f, std::string&) {
	arma_extra_debug_sigprint();
...
template<typename T> inline
bool diskio::load_csv_ascii(Mat<std::complex<T>>& x, std::istream& f, std::string&) {
	arma_extra_debug_sigprint();
			...
			if(loc_i == std::string::npos) {
				...
				if(loc_plus != std::string::npos) {
					if(loc_plus >= 1) {
						...
						if((prev_char != 'e') && (prev_char != 'E')) { found_plus = true; } else {
				...
				if(loc_minus != std::string::npos) {
					if(loc_minus >= 1) {
						...
						// make sure we're not looking at the sign of the exponent
						if((prev_char != 'e') && (prev_char != 'E')) { found_minus = true; } else {
							// search again, omitting the exponent
...
//! with a header that indicates the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_binary(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_arma_binary(Mat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
inline
void diskio::pnm_skip_comments(std::istream& f) {
	while(isspace(f.peek())) {
		while(isspace(f.peek())) { f.get(); }

		if(f.peek() == '#') { while((f.peek() != '\r') && (f.peek() != '\n')) { f.get(); } }
	}
}

//! Load a PGM greyscale image as a matrix
template<typename eT> inline
bool diskio::load_pgm_binary(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! Load a PGM greyscale image as a matrix
template<typename eT> inline
bool diskio::load_pgm_binary(Mat<eT>& x, std::istream& f, std::string& err_msg) {
	bool load_okay = true;
...
//! Load a PGM greyscale image as a matrix
template<typename T> inline
bool diskio::load_pgm_binary(Mat<std::complex<T>>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! Load a PGM greyscale image as a matrix
template<typename T> inline
bool diskio::load_pgm_binary(Mat<std::complex<T>>& x, std::istream& is, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_hdf5_binary(Mat<eT>& x, const hdf5_name& spec, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
#if defined(ARMA_USE_HDF5)
	{
		...
		if(fid >= 0) {
			...
			if(exact) { searchNames.push_back(spec.dsname); } else {
			...
			if(load_okay == false) { err_msg = "unsupported or missing HDF5 data in "; }
		} else { err_msg = "cannot open file "; }
...
template<typename eT> inline
bool diskio::load_auto_detect(Mat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! Try to load a matrix by automatically determining its type
template<typename eT> inline
bool diskio::load_auto_detect(Mat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	...
	if(std::strncmp(ARMA_MAT_TXT_str, header_mem, size_t(ARMA_MAT_TXT_len)) == 0) { return load_arma_ascii(x, f, err_msg); } else if(std::strncmp(ARMA_MAT_BIN_str, header_mem, size_t(ARMA_MAT_BIN_len)) == 0) { return load_arma_binary(x, f, err_msg); } else if(std::strncmp(P5_str, header_mem, size_t(P5_len)) == 0) { return load_pgm_binary(x, f, err_msg); } else {
...
template<typename eT> inline
bool diskio::save_coord_ascii(const SpMat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! Save a matrix in ASCII coord format
template<typename eT> inline
bool diskio::save_coord_ascii(const SpMat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
	...
	for(; iter != iter_end; ++iter) { f << iter.row() << ' ' << iter.col() << ' ' << (*iter) << '\n'; }
	...
	if((x.n_rows > 0) && (x.n_cols > 0)) {
		...
		if(x.at(max_row, max_col) == eT(0)) { f << max_row << ' ' << max_col << " 0\n"; }
	}
...
template<typename T> inline
bool diskio::save_coord_ascii(const SpMat<std::complex<T>>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
	...
	if((x.n_rows > 0) && (x.n_cols > 0)) {
		...
		if(x.at(max_row, max_col) == eT(0)) { f << max_row << ' ' << max_col << " 0 0\n"; }
	}
...
//! with a header that stores the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::save_arma_binary(const SpMat<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! with a header that stores the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::save_arma_binary(const SpMat<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_coord_ascii(SpMat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_coord_ascii(SpMat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	arma_ignore(err_msg);
...
template<typename T> inline
bool diskio::load_coord_ascii(SpMat<std::complex<T>>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	arma_ignore(err_msg);
	...
	if(load_okay) {
		...
		while(f.good()) {
			...
			if((val_real != T(0)) || (val_imag != T(0))) { tmp(line_row, line_col) = std::complex<T>(val_real, val_imag); }
		}
...
//! with a header that indicates the matrix type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_binary(SpMat<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_arma_binary(SpMat<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	...
	if(f_header == diskio::gen_bin_header(x)) {
		...
		for(uword i = 0; i < x.n_cols; ++i) {
			if(x.col_ptrs[i + 1] < x.col_ptrs[i]) {
				check2 = false;
				break;
			}
		}
		...
		if((check1 == true) && ((check2 == false) || (check3 == false))) {
			if(sizeof(uword) == 8) {
				...
				podarray<u32> tmp_a(x.n_nonzero);
				tmp_a.zeros();
				podarray<u32> tmp_b(x.n_cols + 1);
				tmp_b.zeros();
				...
				} else { arma_extra_debug_print("reading integer parts as u32 failed"); }
			}
		}
...
template<typename eT> inline
bool diskio::save_raw_ascii(const Cube<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! Save a cube as raw text (no header, human readable).
template<typename eT> inline
bool diskio::save_raw_ascii(const Cube<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_raw_binary(const Cube<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_raw_binary(const Cube<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_arma_ascii(const Cube<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! with a header that indicates the cube type as well as its dimensions
template<typename eT> inline
bool diskio::save_arma_ascii(const Cube<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_arma_binary(const Cube<eT>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
//! with a header that stores the cube type as well as its dimensions
template<typename eT> inline
bool diskio::save_arma_binary(const Cube<eT>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::save_hdf5_binary(const Cube<eT>& x, const hdf5_name& spec, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! NOTE: this is much slower than reading a file with a header.
template<typename eT> inline
bool diskio::load_raw_ascii(Cube<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! NOTE: this is much slower than reading a file with a header.
template<typename eT> inline
bool diskio::load_raw_ascii(Cube<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_raw_binary(Cube<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_raw_binary(Cube<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	arma_ignore(err_msg);
...
//! with a header that indicates the cube type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_ascii(Cube<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! with a header that indicates the cube type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_ascii(Cube<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	...
	if(f_header == diskio::gen_txt_header(x)) {
		...
		for(uword slice = 0; slice < x.n_slices; ++slice) for(uword row = 0; row < x.n_rows; ++row) for(uword col = 0; col < x.n_cols; ++col) { f >> x.at(row, col, slice); }
...
//! with a header that indicates the cube type as well as its dimensions
template<typename eT> inline
bool diskio::load_arma_binary(Cube<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_arma_binary(Cube<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename eT> inline
bool diskio::load_hdf5_binary(Cube<eT>& x, const hdf5_name& spec, std::string& err_msg) {
	arma_extra_debug_sigprint();
		...
		if(fid >= 0) {
			...
			if(dataset >= 0) {
				...
				if(ndims == 1) {
					dims[1] = 1;
					dims[2] = 1;
				}                               // Vector case; one row/colum, several slices
...
template<typename eT> inline
bool diskio::load_auto_detect(Cube<eT>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! Try to load a cube by automatically determining its type
template<typename eT> inline
bool diskio::load_auto_detect(Cube<eT>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	...
	if(std::strncmp(ARMA_CUB_TXT_str, header_mem, size_t(ARMA_CUB_TXT_len)) == 0) { return load_arma_ascii(x, f, err_msg); } else if(std::strncmp(ARMA_CUB_BIN_str, header_mem, size_t(ARMA_CUB_BIN_len)) == 0) { return load_arma_binary(x, f, err_msg); } else if(std::strncmp(P6_str, header_mem, size_t(P6_len)) == 0) { return load_ppm_binary(x, f, err_msg); } else {
		const file_type ft = guess_file_type(f);
...
bool diskio::save_arma_binary(const field<T1>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool diskio::save_arma_binary(const field<T1>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool diskio::load_arma_binary(field<T1>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool diskio::load_arma_binary(field<T1>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
inline
bool diskio::save_std_string(const field<std::string>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
inline
bool diskio::save_std_string(const field<std::string>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
...
inline
bool diskio::load_std_string(field<std::string>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
inline
bool diskio::load_std_string(field<std::string>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	...
	if(load_okay) {
		...
		for(uword row = 0; row < x.n_rows; ++row) for(uword col = 0; col < x.n_cols; ++col) { f >> x.at(row, col); }
	}
...
template<typename T1> inline
bool diskio::load_auto_detect(field<T1>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
//! Try to load a field by automatically determining its type
template<typename T1> inline
bool diskio::load_auto_detect(field<T1>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
	...
	if(ARMA_FLD_BIN == header.substr(0, ARMA_FLD_BIN.length())) { return load_arma_binary(x, f, err_msg); } else if(ARMA_FL3_BIN == header.substr(0, ARMA_FL3_BIN.length())) { return load_arma_binary(x, f, err_msg); } else if(P6 == header.substr(0, P6.length())) { return load_ppm_binary(x, f, err_msg); } else {
		err_msg = "unsupported header in ";
		return false;
	}
}
...
template<typename T1> inline
bool diskio::load_ppm_binary(field<T1>& x, const std::string& name, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool diskio::load_ppm_binary(field<T1>& x, std::istream& f, std::string& err_msg) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool diskio::save_ppm_binary(const field<T1>& x, const std::string& final_name) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
bool diskio::save_ppm_binary(const field<T1>& x, std::ostream& f) {
	arma_extra_debug_sigprint();
