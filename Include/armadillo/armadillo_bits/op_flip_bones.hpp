...
public:
	...
	template<typename eT> inline static void apply_direct(Mat<eT>& out, const Mat<eT>& X);

	template<typename T1> inline static void apply_proxy_noalias(Mat<typename T1::elem_type>& out, const Proxy<T1>& P);
};
