...
template<typename out_eT, typename T1, typename op_type> class mtSpOp : public SpBase<out_eT, mtSpOp<out_eT, T1, op_type>> {
public:
	...
	template<typename eT2> arma_inline bool is_alias(const SpMat<eT2>& X) const;
