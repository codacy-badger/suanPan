...
inline arma_ostream_state::arma_ostream_state(const std::ostream& o)
	: orig_flags(o.flags())
...
std::streamsize arma_ostream::modify_stream(std::ostream& o, const eT* data, const uword n_elem) {
...
std::streamsize arma_ostream::modify_stream(std::ostream& o, const std::complex<T>* data, const uword n_elem) {
	arma_ignore(data);
	arma_ignore(n_elem);
...
template<typename eT> inline
std::streamsize arma_ostream::modify_stream(std::ostream& o, typename SpMat<eT>::const_iterator begin, const uword n_elem, const typename arma_not_cx<eT>::result* junk) {
...
template<typename eT> inline
void arma_ostream::print_elem_zero(std::ostream& o, const bool modify) {
	if(modify) {
...
void arma_ostream::print_elem(std::ostream& o, const eT& x, const bool modify) {
	if(is_signed<eT>::value) {
		...
		if(x != eT(0)) { if(arma_isfinite(x)) { o << promoted_eT(x); } else { o << (arma_isinf(x) ? ((x <= eT(0)) ? "-inf" : "inf") : "nan"); } } else { arma_ostream::print_elem_zero<promoted_eT>(o, modify); }
	} else {
		typedef typename promote_type<eT, u16>::result promoted_eT;

		if(x != eT(0)) { o << promoted_eT(x); } else { arma_ostream::print_elem_zero<promoted_eT>(o, modify); }
	}
}
...
inline
void arma_ostream::print(std::ostream& o, const Mat<eT>& m, const bool modify) {
	arma_extra_debug_sigprint();
...
template<typename eT> arma_cold
inline
void arma_ostream::print(std::ostream& o, const Cube<eT>& x, const bool modify) {
	arma_extra_debug_sigprint();
...
inline
void arma_ostream::print(std::ostream& o, const field<oT>& x) {
	arma_extra_debug_sigprint();
...
template<typename oT> arma_cold
inline
void arma_ostream::print(std::ostream& o, const subview_field<oT>& x) {
	arma_extra_debug_sigprint();
...
template<typename eT> arma_cold
inline
void arma_ostream::print_dense(std::ostream& o, const SpMat<eT>& m, const bool modify) {
	arma_extra_debug_sigprint();
...
template<typename eT> arma_cold
inline
void arma_ostream::print(std::ostream& o, const SpMat<eT>& m, const bool modify) {
	arma_extra_debug_sigprint();
...
inline
void arma_ostream::print(std::ostream& o, const SizeMat& S) {
	arma_extra_debug_sigprint();
...
inline
void arma_ostream::print(std::ostream& o, const SizeCube& S) {
	arma_extra_debug_sigprint();
