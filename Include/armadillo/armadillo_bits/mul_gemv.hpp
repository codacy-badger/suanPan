...
public:
	...
	inline
	static
	void apply(eT* y, const TA& A, const eT* x, const eT alpha = eT(1), const eT beta = eT(0)) {
...
public:
	...
	inline
	static
	typename arma_not_cx<eT>::result dot_row_col(const TA& A, const eT* x, const uword row, const uword N) {
		eT acc1 = eT(0);
		eT acc2 = eT(0);
	...
	inline
	static
	typename arma_cx_only<eT>::result dot_row_col(const TA& A, const eT* x, const uword row, const uword N) {
...
public:
	...
	template<typename eT, typename TA> arma_inline
	static
	void apply(eT* y, const TA& A, const eT* x, const eT alpha = eT(1), const eT beta = eT(0)) { gemv_emul<do_trans_A, use_alpha, use_beta>::apply(y, A, x, alpha, beta); }

	template<typename TA> arma_inline
	static
	void apply
	(
		float* y,
