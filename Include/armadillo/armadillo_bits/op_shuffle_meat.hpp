...
void op_shuffle::apply_direct(Mat<eT>& out, const Mat<eT>& X, const uword dim) {
...
void op_shuffle::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_shuffle>& in) {
	arma_extra_debug_sigprint();
...
template<typename T1> inline
void op_shuffle_default::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_shuffle_default>& in) {
	arma_extra_debug_sigprint();
