...
arma_inline
void op_htrans::apply_mat_noalias(Mat<eT>& out, const Mat<eT>& A, const typename arma_not_cx<eT>::result* junk) {
...
template<typename eT> arma_hot
inline
void op_htrans::apply_mat_noalias(Mat<eT>& out, const Mat<eT>& A, const typename arma_cx_only<eT>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
	...
	} else if((A_n_rows >= 512) && (A_n_cols >= 512)) { op_htrans::apply_mat_noalias_large(out, A); } else {
...
template<typename T> arma_hot
inline
void op_htrans::block_worker(std::complex<T>* Y, const std::complex<T>* X, const uword X_n_rows, const uword Y_n_rows, const uword n_rows, const uword n_cols) {
...
template<typename T> arma_hot
inline
void op_htrans::apply_mat_noalias_large(Mat<std::complex<T>>& out, const Mat<std::complex<T>>& A) {
	arma_extra_debug_sigprint();
...
template<typename eT> arma_hot
arma_inline
void op_htrans::apply_mat_inplace(Mat<eT>& out, const typename arma_not_cx<eT>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename eT> arma_hot
inline
void op_htrans::apply_mat_inplace(Mat<eT>& out, const typename arma_cx_only<eT>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename eT> arma_hot
arma_inline
void op_htrans::apply_mat(Mat<eT>& out, const Mat<eT>& A, const typename arma_not_cx<eT>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename eT> arma_hot
inline
void op_htrans::apply_mat(Mat<eT>& out, const Mat<eT>& A, const typename arma_cx_only<eT>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);

	if(&out != &A) { op_htrans::apply_mat_noalias(out, A); } else { op_htrans::apply_mat_inplace(out); }
}

template<typename T1> arma_hot
inline
void op_htrans::apply_proxy(Mat<typename T1::elem_type>& out, const T1& X) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_htrans::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_htrans>& in, const typename arma_not_cx<typename T1::elem_type>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename T1> arma_hot
inline
void op_htrans::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_htrans>& in, const typename arma_cx_only<typename T1::elem_type>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename T1> arma_hot
inline
void op_htrans::apply(Mat<typename T1::elem_type>& out, const Op<Op<T1, op_trimat>, op_htrans>& in) {
	arma_extra_debug_sigprint();
...
template<typename eT> arma_hot
arma_inline
void op_htrans2::apply_noalias(Mat<eT>& out, const Mat<eT>& A, const eT val) {
	arma_extra_debug_sigprint();
	...
	} else if((A_n_rows >= 512) && (A_n_cols >= 512)) {
...
template<typename eT> arma_hot
inline
void op_htrans2::apply(Mat<eT>& out, const Mat<eT>& A, const eT val) {
	arma_extra_debug_sigprint();

	if(&out != &A) { op_htrans2::apply_noalias(out, A, val); } else {
		const uword n_rows = out.n_rows;
		const uword n_cols = out.n_cols;
...
template<typename T1> arma_hot
inline
void op_htrans2::apply_proxy(Mat<typename T1::elem_type>& out, const T1& X, const typename T1::elem_type val) {
	arma_extra_debug_sigprint();
...
template<typename T1> arma_hot
inline
void op_htrans2::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_htrans2>& in, const typename arma_not_cx<typename T1::elem_type>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
...
template<typename T1> arma_hot
inline
void op_htrans2::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_htrans2>& in, const typename arma_cx_only<typename T1::elem_type>::result* junk) {
	arma_extra_debug_sigprint();
	arma_ignore(junk);
