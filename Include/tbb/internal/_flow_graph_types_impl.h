...
namespace internal {
	...
	template<typename Kp, typename KHashp, typename Tp> struct KeyTrait {
		typedef Kp K;
		typedef Tp T;
	...
	template<int N, template<class> class PT, typename TypeTuple> struct wrap_tuple_elements;

	// A wrapper that generates the traits needed for each port of a key-matching join,
	// and the type of the tuple of input ports.
	template<int N, template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements;

	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<1, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>>
		type;
	};

	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<1, PT, KeyTraits, TypeTuple> {
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<2, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<2, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<3, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<3, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<4, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<4, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<5, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<5, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<6, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<6, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<7, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<7, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<8, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<8, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<9, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<9, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<template<class> class PT, typename TypeTuple> struct wrap_tuple_elements<10, PT, TypeTuple> {
		typedef typename tbb::flow::tuple<
			PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<1, TypeTuple>::type>,
			PT<typename tbb::flow::tuple_element<2, TypeTuple>::type>,
	...
	template<template<class> class PT, typename KeyTraits, typename TypeTuple> struct wrap_key_tuple_elements<10, PT, KeyTraits, TypeTuple> {
		typedef typename KeyTraits::key_type K;
		typedef typename KeyTraits::hash_compare_type KHash;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<0, TypeTuple>::type> KeyTrait0;
		typedef KeyTrait<K, KHash, typename tbb::flow::tuple_element<1, TypeTuple>::type> KeyTrait1;
	...
	template<typename T> class initializer_list_wrapper {
	public:
		...
		initializer_list_wrapper(std::initializer_list<T> il) __TBB_NOEXCEPT( true )
			...
			for(typename std::initializer_list<T>::const_iterator src = il.begin(); src != il.end(); ++src) new(dst++) T(*src);
			my_end = dst;
		}
		...
		initializer_list_wrapper(const initializer_list_wrapper<T>& ilw) __TBB_NOEXCEPT( true )
			...
			iterator dst = my_begin;
			for(typename std::initializer_list<T>::const_iterator src = ilw.begin(); src != ilw.end(); ++src) new(dst++) T(*src);
			my_end = dst;
		}

#if __TBB_CPP11_RVALUE_REF_PRESENT
		initializer_list_wrapper(initializer_list_wrapper<T>&& ilw) __TBB_NOEXCEPT( true )
			: my_begin(ilw.my_begin)
			, my_end(ilw.my_end) { ilw.my_begin = ilw.my_end = NULL; }
#endif /* __TBB_CPP11_RVALUE_REF_PRESENT */

		~initializer_list_wrapper() { if(my_begin) free(my_begin); }
	...
	template<typename T1, typename T2, size_t REM> struct type_plus_align {
		char first[sizeof(T1)];
		T2 second;
		char fill1[REM];
	};

	template<typename T1, typename T2> struct type_plus_align<T1, T2, 0> {
		char first[sizeof(T1)];
		T2 second;
	};
	...
	template<typename T1, typename T2> struct aligned_pair {
	...
	private:
		...
		struct _unwind_space {
			...
			~_unwind_space() { if(space) (void)new(space) Wrapper<default_constructed>(default_constructed()); }
		};

	public:
		explicit Wrapper(const T& other)
			: value_space(other) { }
	...
	template<typename T, size_t N> struct Wrapper<T[N]> : public WrapperBase {
		typedef T value_type;
		typedef T* pointer_type;
	...
	template<class T1, class T2> struct pick_one<true, T1, T2> {
		typedef T1 type;
	};

	template<class T1, class T2> struct pick_one<false, T1, T2> {
		typedef T2 type;
	};

	template<template<class> class Selector, typename T1, typename T2> struct pick_max {
	...
	template<class Q, size_t N, class Tuple> struct is_element_of {
	...
	template<class Q, class Tuple> struct is_element_of<Q, 0, Tuple> {
	...
	template<typename T> struct do_if<T, true> {
		static void construct(void* mySpace, const T& x) { (void)new(mySpace) Wrapper<T>(x); }
	};

	template<typename T> struct do_if<T, false> {
	...
	template<typename TagType, typename T0, typename T1=tagged_null_type, typename T2=tagged_null_type, typename T3=tagged_null_type,
	         ...
	         typename T7=tagged_null_type, typename T8=tagged_null_type, typename T9=tagged_null_type> class tagged_msg {
	...
	private:
		...
		public:
			...
			template<typename T> variant(const T& x) { do_if<T, is_element_of<T, N, Tuple>::value>::construct(&my_space, x); }
			...
			template<typename U> const U& variant_cast_to() const {
				const Wrapper<U>* h = dynamic_cast<const Wrapper<U>*>(punned_cast<const WrapperBase *>(&my_space));
				if(!h) { tbb::internal::throw_exception(tbb::internal::eid_bad_tagged_msg_cast); }
				return h->value();
			}

			template<typename U> bool variant_is_a() const { return dynamic_cast<const Wrapper<U>*>(punned_cast<const WrapperBase *>(&my_space)) != NULL; }
    ...
    tagged_msg(T const &index,  R (&value)[N]) : my_tag(index), my_msg(value) {}
		...
		template<typename V> const V& cast_to() const { return my_msg.template variant_cast_to<V>(); }

		template<typename V> bool is_a() const { return my_msg.template variant_is_a<V>(); }
	...
	template<typename V, typename T> const V& cast_to(T const& t) { return t.template cast_to<V>(); }

	template<typename V, typename T> bool is_a(T const& t) { return t.template is_a<V>(); }
