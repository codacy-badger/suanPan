		...
		public:
			...
			*/
			...
			public:
				...
				void* operator new(size_t s) { return tbb::internal::allocate_via_handler_v3(s); }

				void operator delete(void* p) { tbb::internal::deallocate_via_handler_v3(p); }
			...
			public:
				...
				scoped_lock_read(reader_writer_lock& lock) { internal_construct(lock); }
