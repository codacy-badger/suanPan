...
namespace tbb {
	...
	/** @ingroup algorithms */
	template<typename PageValue, typename RowValue=PageValue, typename ColValue=RowValue> class blocked_range3d {
	public:
	...
	public:
		...
		bool is_divisible() const { return my_pages.is_divisible() || my_rows.is_divisible() || my_cols.is_divisible(); }
		...
		blocked_range3d(blocked_range3d& r, proportional_split& proportion)
			...
			my_pages(r.my_pages)
			, my_rows(r.my_rows)
			, my_cols(r.my_cols) { do_split(r, proportion); }
