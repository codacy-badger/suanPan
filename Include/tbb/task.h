...
#define __TBB_TASK_BASE_ACCESS private
	...
	namespace interface5 {
		namespace internal {
			...
			__TBB_TASK_BASE_ACCESS:
				...
				static tbb::internal::allocate_additional_child_of_proxy allocate_additional_child_of(task& t) { return tbb::internal::allocate_additional_child_of_proxy(t); }
	...
	public:
		...
		task_group_context(kind_type relation_with_parent = bound,
			...
			, my_name(internal::CUSTOM_CTX) { init(); }
	...
	private:
		...
		template<typename T> void propagate_task_group_state(T task_group_context::* mptr_state, task_group_context& src, T new_state);
	...
	public:
		...
		static internal::allocate_root_with_context_proxy allocate_root(task_group_context& ctx) { return internal::allocate_root_with_context_proxy(ctx); }
#endif /* __TBB_TASK_GROUP_CONTEXT */

		//! Returns proxy for overloaded new that allocates a continuation task of *this.
		/** The continuation's parent becomes the parent of *this. */
		internal::allocate_continuation_proxy& allocate_continuation() { return *reinterpret_cast<internal::allocate_continuation_proxy*>(this); }
    ...
    void recycle_to_enqueue() {
		...
		int add_ref_count(int count) {
			...
			if(k == 0) internal::call_itt_notify(internal::acquired, &prefix().ref_count);
			return int(k);
		}
	...
	private:
		...
		internal::task_prefix& prefix(internal::version_tag* = NULL) const { return reinterpret_cast<internal::task_prefix*>(const_cast<task*>(this))[-1]; }
#if __TBB_PREVIEW_CRITICAL_TASKS
...
inline bool is_critical( task& t ) { return bool((t.prefix().extra_state & 0x8) != 0); }
	...
	//! @cond INTERNAL
	namespace internal {
		template<typename F> class function_task : public task {
...
inline void operator delete(void* task, const tbb::internal::allocate_root_with_context_proxy& p) { p.free(*static_cast<tbb::task*>(task)); }
#endif /* __TBB_TASK_GROUP_CONTEXT */
