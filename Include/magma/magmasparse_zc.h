...
*/
magma_int_t magma_vector_zlag2c(
	magma_z_matrix x,
	magma_c_matrix* y,
	magma_queue_t queue);

magma_int_t magma_sparse_matrix_zlag2c(
	magma_z_matrix A,
	magma_c_matrix* B,
	magma_queue_t queue);

magma_int_t magma_vector_clag2z(
	magma_c_matrix x,
	magma_z_matrix* y,
	magma_queue_t queue);

magma_int_t magma_sparse_matrix_clag2z(
	magma_c_matrix A,
	magma_z_matrix* B,
	magma_queue_t queue);

void magmablas_zlag2c_sparse(
	magma_int_t M,
	magma_int_t N,
...
void magma_zlag2c_CSR_DENSE(
	magma_z_matrix A,
	magma_c_matrix* B,
	magma_queue_t queue);

void magma_zlag2c_CSR_DENSE_alloc(
	magma_z_matrix A,
	magma_c_matrix* B,
	magma_queue_t queue);

void magma_zlag2c_CSR_DENSE_convert(
	magma_z_matrix A,
	magma_c_matrix* B,
	magma_queue_t queue);
...
magma_int_t magma_zcgecsrmv_mixed_prec(
