...
magma_int_t magma_dgeqrf2_gpu(
	magma_int_t m, magma_int_t n,
	magmaDouble_ptr dA, magma_int_t ldda,
	double* tau,
	magma_int_t* info);

magma_int_t magma_dgeqrf2_mgpu(
	magma_int_t ngpu,
	magma_int_t m, magma_int_t n,
...
// CUDA MAGMA only
magma_int_t magma_dgerfs_nopiv_gpu(
...
magma_int_t magma_dgesv_nopiv_gpu(
	magma_int_t n, magma_int_t nrhs,
	magmaDouble_ptr dA, magma_int_t ldda,
	magmaDouble_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dgesv_rbt(
	magma_bool_t ref, magma_int_t n, magma_int_t nrhs,
	double* A, magma_int_t lda,
	double* B, magma_int_t ldb,
	magma_int_t* info);

magma_int_t magma_dgesvd(
...
// CUDA MAGMA only
magma_int_t magma_dgetf2_nopiv(
	magma_int_t m, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dgetrf2(
	magma_int_t m, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* ipiv,
	magma_int_t* info);

magma_int_t magma_dgetrf2_mgpu(
	magma_int_t ngpu,
...
// CUDA MAGMA only
magma_int_t magma_dgetrf_nopiv(
	magma_int_t m, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dgetrs_nopiv_gpu(
	magma_trans_t trans, magma_int_t n, magma_int_t nrhs,
	magmaDouble_ptr dA, magma_int_t ldda,
	magmaDouble_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dsyevdx_2stage(
	magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo,
	magma_int_t n,
	double* A, magma_int_t lda,
	double vl, double vu, magma_int_t il, magma_int_t iu,
...
// CUDA MAGMA only
magma_int_t magma_dsygvdx_2stage_m(
	magma_int_t ngpu,
	magma_int_t itype, magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo,
	magma_int_t n,
	double* A, magma_int_t lda,
...
// CUDA MAGMA only
magma_int_t magma_dsysv_nopiv_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaDouble_ptr dA, magma_int_t ldda,
	magmaDouble_ptr dB, magma_int_t lddb,
	magma_int_t* info);

magma_int_t magma_dsytrd(
...
// CUDA MAGMA only
magma_int_t magma_dsytrd_sb2st(
...
// CUDA MAGMA only
magma_int_t magma_dsytrd_sy2sb(
...
// CUDA MAGMA only
magma_int_t magma_dsytrd_sy2sb_mgpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nb,
	double* A, magma_int_t lda,
	double* tau,
	double* work, magma_int_t lwork,
...
// CUDA MAGMA only
magma_int_t magma_dsytrf_aasen(
	magma_uplo_t uplo, magma_int_t cpu_panel, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* ipiv, magma_int_t* info);

magma_int_t magma_dsytrf_nopiv(
	magma_uplo_t uplo, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_dsytrf_nopiv_cpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t ib,
	double* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_dsytrf_nopiv_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaDouble_ptr dA, magma_int_t ldda,
	magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_dsytrs_nopiv_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaDouble_ptr dA, magma_int_t ldda,
	magmaDouble_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
magma_int_t magma_dlauum(
	magma_uplo_t uplo, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_dlauum_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaDouble_ptr dA, magma_int_t ldda,
	magma_int_t* info);

// ------------------------------------------------------------ zpo routines
magma_int_t magma_dposv(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	double* A, magma_int_t lda,
	double* B, magma_int_t ldb,
	magma_int_t* info);

magma_int_t magma_dposv_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaDouble_ptr dA, magma_int_t ldda,
	magmaDouble_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dpotf2_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaDouble_ptr dA, magma_int_t ldda,
	magma_queue_t queue,
	magma_int_t* info);

magma_int_t magma_dpotrf(
	magma_uplo_t uplo, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dpotrf_m(
	magma_int_t ngpu,
	magma_uplo_t uplo, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_dpotrf_mgpu(
	magma_int_t ngpu,
	magma_uplo_t uplo, magma_int_t n,
	magmaDouble_ptr d_lA[], magma_int_t ldda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dpotrf_mgpu_right(
	magma_int_t ngpu,
	magma_uplo_t uplo, magma_int_t n,
	magmaDouble_ptr d_lA[], magma_int_t ldda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_dpotrf3_mgpu(
	magma_int_t ngpu,
...
magma_int_t magma_dpotri(
	magma_uplo_t uplo, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_dpotri_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaDouble_ptr dA, magma_int_t ldda,
	magma_int_t* info);

magma_int_t magma_dpotrs_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaDouble_ptr dA, magma_int_t ldda,
	magmaDouble_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
magma_int_t magma_dtrtri(
	magma_uplo_t uplo, magma_diag_t diag, magma_int_t n,
	double* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_dtrtri_gpu(
	magma_uplo_t uplo, magma_diag_t diag, magma_int_t n,
	magmaDouble_ptr dA, magma_int_t ldda,
	magma_int_t* info);
...
magma_int_t magma_dorgqr2(
	magma_int_t m, magma_int_t n, magma_int_t k,
	double* A, magma_int_t lda,
	double* tau,
	magma_int_t* info);

magma_int_t magma_dormbr(
