...
*/
magma_int_t magma_vector_dlag2s(
	magma_d_matrix x,
	magma_s_matrix* y,
	magma_queue_t queue);

magma_int_t magma_sparse_matrix_dlag2s(
	magma_d_matrix A,
	magma_s_matrix* B,
	magma_queue_t queue);

magma_int_t magma_vector_slag2d(
	magma_s_matrix x,
	magma_d_matrix* y,
	magma_queue_t queue);

magma_int_t magma_sparse_matrix_slag2d(
	magma_s_matrix A,
	magma_d_matrix* B,
	magma_queue_t queue);

void magmablas_dlag2s_sparse(
	magma_int_t M,
	magma_int_t N,
...
void magma_dlag2s_CSR_DENSE(
	magma_d_matrix A,
	magma_s_matrix* B,
	magma_queue_t queue);

void magma_dlag2s_CSR_DENSE_alloc(
	magma_d_matrix A,
	magma_s_matrix* B,
	magma_queue_t queue);

void magma_dlag2s_CSR_DENSE_convert(
	magma_d_matrix A,
	magma_s_matrix* B,
	magma_queue_t queue);
...
magma_int_t magma_dsgecsrmv_mixed_prec(
