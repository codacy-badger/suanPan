...
magma_int_t magma_sbulge_applyQ_v2(
	magma_side_t side,
...
magma_int_t magma_sbulge_applyQ_v2_m(
...
magma_int_t magma_sbulge_back_m(
...
void magma_strdtype1cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
...
void magma_strdtype2cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
	float* A, magma_int_t lda,
	float* V, magma_int_t ldv,
	float* TAU,
...
void magma_strdtype3cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
	float* A, magma_int_t lda,
	float* V, magma_int_t ldv,
	float* TAU,
...
void magma_ssbtype1cb(magma_int_t n, magma_int_t nb,
                      float* A, magma_int_t lda,
                      float* V, magma_int_t LDV,
                      float* TAU,
...
void magma_ssbtype2cb(magma_int_t n, magma_int_t nb,
                      float* A, magma_int_t lda,
                      float* V, magma_int_t ldv,
                      float* TAU,
                      magma_int_t st, magma_int_t ed, magma_int_t sweep,
                      magma_int_t Vblksiz, magma_int_t wantz,
                      float* work);
void magma_ssbtype3cb(magma_int_t n, magma_int_t nb,
                      float* A, magma_int_t lda,
                      float* V, magma_int_t ldv,
                      float* TAU,
                      magma_int_t st, magma_int_t ed, magma_int_t sweep,
...
magma_int_t magma_sormqr_2stage_gpu(
...
magma_int_t magma_sbulge_getstg2size(magma_int_t n, magma_int_t nb, magma_int_t wantz,
...
magma_int_t magma_sbulge_getlwstg2(magma_int_t n, magma_int_t threads, magma_int_t wantz,
                                   magma_int_t* Vblksiz, magma_int_t* ldv, magma_int_t* ldt,
                                   magma_int_t* blkcnt, magma_int_t* sizTAU2,
                                   magma_int_t* sizT2, magma_int_t* sizV2);
...
void magma_bulge_get_VTsiz(magma_int_t n, magma_int_t nb, magma_int_t threads,
                           magma_int_t* Vblksiz, magma_int_t* ldv, magma_int_t* ldt);
void magma_ssyevdx_getworksize(magma_int_t n, magma_int_t threads,
                               magma_int_t wantz,
                               magma_int_t* lwmin,
#ifdef MAGMA_COMPLEX
        magma_int_t *lrwmin, 
...
magma_int_t magma_ssytrd_bsy2trc_v5(
...
magma_int_t magma_sorgqr_2stage_gpu(
