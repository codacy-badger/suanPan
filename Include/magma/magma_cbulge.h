/*
    -- MAGMA (version 2.4.0) --
       ...
       @generated from include/magma_zbulge.h, normal z -> c, Mon Jun 25 18:24:32 2018
*/
...
magma_int_t magma_cbulge_applyQ_v2(
	magma_side_t side,
...
magma_int_t magma_cbulge_applyQ_v2_m(
...
magma_int_t magma_cbulge_back_m(
...
void magma_ctrdtype1cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
...
void magma_ctrdtype2cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
	magmaFloatComplex* A, magma_int_t lda,
	magmaFloatComplex* V, magma_int_t ldv,
	magmaFloatComplex* TAU,
...
void magma_ctrdtype3cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
	magmaFloatComplex* A, magma_int_t lda,
	magmaFloatComplex* V, magma_int_t ldv,
	magmaFloatComplex* TAU,
...
void magma_chbtype1cb(magma_int_t n, magma_int_t nb,
                      magmaFloatComplex* A, magma_int_t lda,
                      magmaFloatComplex* V, magma_int_t LDV,
                      magmaFloatComplex* TAU,
...
void magma_chbtype2cb(magma_int_t n, magma_int_t nb,
                      magmaFloatComplex* A, magma_int_t lda,
                      magmaFloatComplex* V, magma_int_t ldv,
                      magmaFloatComplex* TAU,
                      magma_int_t st, magma_int_t ed, magma_int_t sweep,
                      magma_int_t Vblksiz, magma_int_t wantz,
                      magmaFloatComplex* work);
void magma_chbtype3cb(magma_int_t n, magma_int_t nb,
                      magmaFloatComplex* A, magma_int_t lda,
                      magmaFloatComplex* V, magma_int_t ldv,
                      magmaFloatComplex* TAU,
                      magma_int_t st, magma_int_t ed, magma_int_t sweep,
...
magma_int_t magma_cunmqr_2stage_gpu(
...
magma_int_t magma_cbulge_getstg2size(magma_int_t n, magma_int_t nb, magma_int_t wantz,
...
magma_int_t magma_cbulge_getlwstg2(magma_int_t n, magma_int_t threads, magma_int_t wantz,
                                   magma_int_t* Vblksiz, magma_int_t* ldv, magma_int_t* ldt,
                                   magma_int_t* blkcnt, magma_int_t* sizTAU2,
                                   magma_int_t* sizT2, magma_int_t* sizV2);

void magma_bulge_get_VTsiz(magma_int_t n, magma_int_t nb, magma_int_t threads,
                           magma_int_t* Vblksiz, magma_int_t* ldv, magma_int_t* ldt);
void magma_cheevdx_getworksize(magma_int_t n, magma_int_t threads,
                               magma_int_t wantz,
                               magma_int_t* lwmin,
#ifdef MAGMA_COMPLEX
                               magma_int_t* lrwmin,
...
magma_int_t magma_chetrd_bhe2trc_v5(
...
magma_int_t magma_cungqr_2stage_gpu(
