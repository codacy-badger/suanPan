/*
    -- MAGMA (version 2.4.0) --
       ...
       @generated from include/magma_zlapack.h, normal z -> s, Mon Jun 25 18:24:32 2018
*/
...
void lapackf77_sgbsv(const magma_int_t* n,
                     const magma_int_t* kl, const magma_int_t* ku,
...
void lapackf77_sgerqf(const magma_int_t* m, const magma_int_t* n,
                      float* A, const magma_int_t* lda,
                      float* tau,
                      float* work, const magma_int_t* lwork,
                      magma_int_t* info);
...
void lapackf77_sgglse(magma_int_t* m, magma_int_t* n, magma_int_t* p,
...
void lapackf77_sggrqf(magma_int_t* m, magma_int_t* p, magma_int_t* n,
                      float* A, magma_int_t* lda,
                      float* tauA, float* B,
                      magma_int_t* ldb, float* tauB,
                      float* work, magma_int_t* lwork,
                      magma_int_t* info);

void lapackf77_ssytf2(const char* uplo, const magma_int_t* n,
                      float* A, const magma_int_t* lda,
                      magma_int_t* ipiv,
                      magma_int_t* info);
...
void lapackf77_slaqp2(const magma_int_t* m, const magma_int_t* n, const magma_int_t* offset,
                      float* A, const magma_int_t* lda,
                      magma_int_t* jpvt,
                      float* tau,
                      float* vn1, float* vn2,
...
void lapackf77_slarf(const char* side, const magma_int_t* m, const magma_int_t* n,
                     const float* v, const magma_int_t* incv,
                     const float* tau,
                     float* C, const magma_int_t* ldc,
                     float* work);
...
void lapackf77_slatms(const magma_int_t* m, const magma_int_t* n,
