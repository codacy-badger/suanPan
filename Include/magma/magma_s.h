/*
    -- MAGMA (version 2.4.0) --
       ...
       @generated from include/magma_z.h, normal z -> s, Mon Jun 25 18:24:32 2018
*/
...
magma_int_t magma_sgeqrf2_gpu(
	magma_int_t m, magma_int_t n,
	magmaFloat_ptr dA, magma_int_t ldda,
	float* tau,
	magma_int_t* info);

magma_int_t magma_sgeqrf2_mgpu(
	magma_int_t ngpu,
	magma_int_t m, magma_int_t n,
...
// CUDA MAGMA only
magma_int_t magma_sgerfs_nopiv_gpu(
...
magma_int_t magma_sgesv_nopiv_gpu(
	magma_int_t n, magma_int_t nrhs,
	magmaFloat_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_sgetf2_nopiv(
	magma_int_t m, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_sgetrf(
	magma_int_t m, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* ipiv,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_sgetrf2(
	magma_int_t m, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* ipiv,
	magma_int_t* info);

magma_int_t magma_sgetrf2_mgpu(
	magma_int_t ngpu,
...
// CUDA MAGMA only
magma_int_t magma_sgetrf_nopiv(
	magma_int_t m, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_sgetrs_nopiv_gpu(
	magma_trans_t trans, magma_int_t n, magma_int_t nrhs,
	magmaFloat_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_ssyevdx_2stage(
	magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo,
	magma_int_t n,
	float* A, magma_int_t lda,
	float vl, float vu, magma_int_t il, magma_int_t iu,
...
// CUDA MAGMA only
magma_int_t magma_ssyevdx_2stage_m(
	magma_int_t ngpu,
	magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo,
	magma_int_t n,
	float* A, magma_int_t lda,
...
// CUDA MAGMA only
magma_int_t magma_ssygvdx_2stage(
...
// CUDA MAGMA only
magma_int_t magma_ssygvdx_2stage_m(
	magma_int_t ngpu,
	magma_int_t itype, magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo,
	magma_int_t n,
	float* A, magma_int_t lda,
...
// CUDA MAGMA only
magma_int_t magma_ssysv_nopiv_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaFloat_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dB, magma_int_t lddb,
	magma_int_t* info);

magma_int_t magma_ssytrd(
...
// CUDA MAGMA only
magma_int_t magma_ssytrd_sb2st(
...
// CUDA MAGMA only
magma_int_t magma_ssytrd_sy2sb(
...
// CUDA MAGMA only
magma_int_t magma_ssytrd_sy2sb_mgpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nb,
	float* A, magma_int_t lda,
	float* tau,
	float* work, magma_int_t lwork,
...
// CUDA MAGMA only
magma_int_t magma_ssytrf_aasen(
	magma_uplo_t uplo, magma_int_t cpu_panel, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* ipiv, magma_int_t* info);

magma_int_t magma_ssytrf_nopiv(
	magma_uplo_t uplo, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_ssytrf_nopiv_cpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t ib,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_ssytrf_nopiv_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaFloat_ptr dA, magma_int_t ldda,
	magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_ssytrs_nopiv_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaFloat_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
magma_int_t magma_slauum(
	magma_uplo_t uplo, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_slauum_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaFloat_ptr dA, magma_int_t ldda,
	magma_int_t* info);

// ------------------------------------------------------------ zpo routines
magma_int_t magma_sposv(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	float* A, magma_int_t lda,
	float* B, magma_int_t ldb,
	magma_int_t* info);

magma_int_t magma_sposv_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaFloat_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_spotf2_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaFloat_ptr dA, magma_int_t ldda,
	magma_queue_t queue,
	magma_int_t* info);

magma_int_t magma_spotrf(
	magma_uplo_t uplo, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_spotrf_m(
	magma_int_t ngpu,
	magma_uplo_t uplo, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_spotrf_mgpu(
	magma_int_t ngpu,
	magma_uplo_t uplo, magma_int_t n,
	magmaFloat_ptr d_lA[], magma_int_t ldda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_spotrf_mgpu_right(
	magma_int_t ngpu,
	magma_uplo_t uplo, magma_int_t n,
	magmaFloat_ptr d_lA[], magma_int_t ldda,
	magma_int_t* info);
...
// CUDA MAGMA only
magma_int_t magma_spotrf3_mgpu(
	magma_int_t ngpu,
...
magma_int_t magma_spotri(
	magma_uplo_t uplo, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_spotri_gpu(
	magma_uplo_t uplo, magma_int_t n,
	magmaFloat_ptr dA, magma_int_t ldda,
	magma_int_t* info);

magma_int_t magma_spotrs_gpu(
	magma_uplo_t uplo, magma_int_t n, magma_int_t nrhs,
	magmaFloat_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dB, magma_int_t lddb,
	magma_int_t* info);
...
magma_int_t magma_strtri(
	magma_uplo_t uplo, magma_diag_t diag, magma_int_t n,
	float* A, magma_int_t lda,
	magma_int_t* info);

magma_int_t magma_strtri_gpu(
	magma_uplo_t uplo, magma_diag_t diag, magma_int_t n,
	magmaFloat_ptr dA, magma_int_t ldda,
	magma_int_t* info);
...
magma_int_t magma_sorgqr2(
	magma_int_t m, magma_int_t n, magma_int_t k,
	float* A, magma_int_t lda,
	float* tau,
	magma_int_t* info);

magma_int_t magma_sormbr(
