/*
    -- MAGMA (version 2.4.0) --
       ...
       @generated from include/magmablas_z_v1.h, normal z -> c, Mon Jun 25 18:24:32 2018
*/
 ...
 * Transpose functions
 */
void magmablas_ctranspose_inplace_v1(
	magma_int_t n,
	magmaFloatComplex_ptr dA, magma_int_t ldda);

void magmablas_ctranspose_conj_inplace_v1(
	magma_int_t n,
	magmaFloatComplex_ptr dA, magma_int_t ldda);

void magmablas_ctranspose_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
	magmaFloatComplex_ptr dAT, magma_int_t lddat);

void magmablas_ctranspose_conj_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
	magmaFloatComplex_ptr dAT, magma_int_t lddat);

void magmablas_cgetmatrix_transpose_v1(
	magma_int_t m, magma_int_t n,
...
void magmablas_csetmatrix_transpose_v1(
	magma_int_t m, magma_int_t n,
 ...
 */
void magmablas_cprbt_v1(
	magma_int_t n,
	magmaFloatComplex_ptr dA, magma_int_t ldda,
	magmaFloatComplex_ptr du,
	magmaFloatComplex_ptr dv);

void magmablas_cprbt_mv_v1(
	magma_int_t n,
	magmaFloatComplex_ptr dv,
	magmaFloatComplex_ptr db);

void magmablas_cprbt_mtv_v1(
	magma_int_t n,
	magmaFloatComplex_ptr du,
	magmaFloatComplex_ptr db);
 ...
 */
void magma_cgetmatrix_1D_col_bcyclic_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_const_ptr const dA[], magma_int_t ldda,
	magmaFloatComplex* hA, magma_int_t lda,
	magma_int_t ngpu, magma_int_t nb);

void magma_csetmatrix_1D_col_bcyclic_v1(
	magma_int_t m, magma_int_t n,
	const magmaFloatComplex* hA, magma_int_t lda,
	magmaFloatComplex_ptr dA[], magma_int_t ldda,
	magma_int_t ngpu, magma_int_t nb);

void magma_cgetmatrix_1D_row_bcyclic_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_const_ptr const dA[], magma_int_t ldda,
	magmaFloatComplex* hA, magma_int_t lda,
	magma_int_t ngpu, magma_int_t nb);

void magma_csetmatrix_1D_row_bcyclic_v1(
	magma_int_t m, magma_int_t n,
	const magmaFloatComplex* hA, magma_int_t lda,
	magmaFloatComplex_ptr dA[], magma_int_t ldda,
	magma_int_t ngpu, magma_int_t nb);
 ...
 */
void magmablas_cgeadd_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex alpha,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
	magmaFloatComplex_ptr dB, magma_int_t lddb);

void magmablas_cgeadd2_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex alpha,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
 ...
 */
void magmablas_scnrm2_adjust_v1(
	magma_int_t k,
	magmaFloat_ptr dxnorm,
	magmaFloatComplex_ptr dc);

void magmablas_scnrm2_check_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dxnorm,
	magmaFloat_ptr dlsticc);

void magmablas_scnrm2_cols_v1(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_ptr dA, magma_int_t ldda,
	magmaFloat_ptr dxnorm);

void magmablas_scnrm2_row_check_adjust_v1(
...
magma_int_t magma_clarfb_gpu_gemm_v1(
	magma_side_t side, magma_trans_t trans, magma_direct_t direct, magma_storev_t storev,
	magma_int_t m, magma_int_t n, magma_int_t k,
	magmaFloatComplex_const_ptr dV, magma_int_t lddv,
	magmaFloatComplex_const_ptr dT, magma_int_t lddt,
...
magma_int_t magmablas_chemv_v1(
...
magma_int_t magmablas_csymv_v1(
	magma_uplo_t uplo, magma_int_t n,
	magmaFloatComplex alpha,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
	magmaFloatComplex_const_ptr dx, magma_int_t incx,
...
void magmablas_cgemm_reduce_v1(
	magma_int_t m, magma_int_t n, magma_int_t k,
	magmaFloatComplex alpha,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
	magmaFloatComplex_const_ptr dB, magma_int_t lddb,
...
void magmablas_ctrsm_outofplace_v1(
	magma_side_t side, magma_uplo_t uplo, magma_trans_t transA, magma_diag_t diag,
	magma_int_t m, magma_int_t n,
	magmaFloatComplex alpha,
	magmaFloatComplex_const_ptr dA, magma_int_t ldda,
...
static inline void magma_csetvector_v1_internal(
	magma_int_t n,
...
static inline void magma_cgetvector_v1_internal(
	magma_int_t n,
...
static inline void magma_ccopyvector_v1_internal(
	magma_int_t n,
	magmaFloatComplex_const_ptr dx_src, magma_int_t incx,
	magmaFloatComplex_ptr dy_dst, magma_int_t incy,
	const char* func, const char* file, int line) {
...
static inline void magma_csetmatrix_v1_internal(
	magma_int_t m, magma_int_t n,
...
static inline void magma_cgetmatrix_v1_internal(
	magma_int_t m, magma_int_t n,
...
static inline void magma_ccopymatrix_v1_internal(
	magma_int_t m, magma_int_t n,
	magmaFloatComplex_const_ptr dA_src, magma_int_t ldda,
	magmaFloatComplex_ptr dB_dst, magma_int_t lddb,
	const char* func, const char* file, int line) {
...
magma_int_t magma_icamax_v1(
	magma_int_t n,
	magmaFloatComplex_const_ptr dx, magma_int_t incx);

// in cublas_v2, result returned through output argument
magma_int_t magma_icamin_v1(
	magma_int_t n,
	magmaFloatComplex_const_ptr dx, magma_int_t incx);

// in cublas_v2, result returned through output argument
float magma_scasum_v1(
	magma_int_t n,
	magmaFloatComplex_const_ptr dx, magma_int_t incx);
