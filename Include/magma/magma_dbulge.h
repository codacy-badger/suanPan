/*
    -- MAGMA (version 2.4.0) --
       ...
       @generated from include/magma_zbulge.h, normal z -> d, Mon Jun 25 18:24:32 2018
*/
...
magma_int_t magma_dbulge_applyQ_v2(
	magma_side_t side,
...
magma_int_t magma_dbulge_applyQ_v2_m(
...
magma_int_t magma_dbulge_back_m(
...
void magma_dtrdtype1cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
...
void magma_dtrdtype2cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
	double* A, magma_int_t lda,
	double* V, magma_int_t ldv,
	double* TAU,
...
void magma_dtrdtype3cbHLsym_withQ_v2(
	magma_int_t n, magma_int_t nb,
	double* A, magma_int_t lda,
	double* V, magma_int_t ldv,
	double* TAU,
...
void magma_dsbtype1cb(magma_int_t n, magma_int_t nb,
                      double* A, magma_int_t lda,
                      double* V, magma_int_t LDV,
                      double* TAU,
...
void magma_dsbtype2cb(magma_int_t n, magma_int_t nb,
                      double* A, magma_int_t lda,
                      double* V, magma_int_t ldv,
                      double* TAU,
                      magma_int_t st, magma_int_t ed, magma_int_t sweep,
                      magma_int_t Vblksiz, magma_int_t wantz,
                      double* work);
void magma_dsbtype3cb(magma_int_t n, magma_int_t nb,
                      double* A, magma_int_t lda,
                      double* V, magma_int_t ldv,
                      double* TAU,
                      magma_int_t st, magma_int_t ed, magma_int_t sweep,
...
magma_int_t magma_dormqr_2stage_gpu(
...
magma_int_t magma_dbulge_getstg2size(magma_int_t n, magma_int_t nb, magma_int_t wantz,
...
magma_int_t magma_dbulge_getlwstg2(magma_int_t n, magma_int_t threads, magma_int_t wantz,
                                   magma_int_t* Vblksiz, magma_int_t* ldv, magma_int_t* ldt,
                                   magma_int_t* blkcnt, magma_int_t* sizTAU2,
                                   magma_int_t* sizT2, magma_int_t* sizV2);
...
void magma_bulge_get_VTsiz(magma_int_t n, magma_int_t nb, magma_int_t threads,
                           magma_int_t* Vblksiz, magma_int_t* ldv, magma_int_t* ldt);
void magma_dsyevdx_getworksize(magma_int_t n, magma_int_t threads,
                               magma_int_t wantz,
                               magma_int_t* lwmin,
#ifdef MAGMA_COMPLEX
        magma_int_t *lrwmin, 
...
magma_int_t magma_dsytrd_bsy2trc_v5(
...
magma_int_t magma_dorgqr_2stage_gpu(
